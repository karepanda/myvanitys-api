...
public class ProductMapperTest {
    ...
    public void testToDomain() {
        ...
        assertEquals(entity.getId(), product.getId().getValue());
    ...
    void shouldMapProductEntityToProduct() {
        ...
        assertNotNull(product);
        assertEquals(entity.getId(), product.getId().getValue()); // UUID directo
    ...
    void shouldMapProductToProductEntity() {
        ...
        // THEN: Se validan los valores convertidos correctamente
        assertNotNull(entity);
        assertEquals(product.getId().getValue(), entity.getId()); // UUID directo
