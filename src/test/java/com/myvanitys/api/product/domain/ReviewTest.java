...
class ReviewTest {
    ...
    void setUp() {
        ...
        user = new User(userId, "auth123", "test@example.com", "User Test");
        ...
        review1 = new Review(reviewId, user, product, 5, "Excelente producto");
    }
    ...
    @Test
    void testToString() {
        String expected = "Review{id=" + review1.getId() + ", user=" + review1.getUser() +
    ...
    void testEqualsAndHashCode() {
        Review review2 = new Review(review1.getId(), review1.getUser(), review1.getProduct(), 5, "Excelente producto");
    ...
    void testDifferentReviewsNotEqual() {
        Review review2 = new Review(new EntityId(UUID.randomUUID()), user, product, 4, "Buen producto");
