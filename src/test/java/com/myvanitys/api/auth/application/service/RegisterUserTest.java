...
class RegisterUserTest {
    ...
    void setUp() {
        ...
        user = new User(EntityId.newId(), googleUserId, userEmail, userName);
        command = new RegisterUserCommand("google", authCode, defaultRedirectUri, Instant.now());
        tokenClaims = new TokenClaims(user.getId().toString(), user.getEmail(), user.getName());
    }
    ...
    void shouldRegisterNewUser() {
        ...
        when(tokenGenerator.generateToken(tokenClaims))
                .thenReturn(jwtToken);
